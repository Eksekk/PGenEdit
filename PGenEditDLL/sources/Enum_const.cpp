...
void makeEnumSkills_7()
{
    ...
    ENUM_TO_STRING_SKILLS = { {SKILL_STAFF, "Staff"}, {SKILL_SWORD, "Sword"}, {SKILL_DAGGER, "Dagger"}, {SKILL_AXE, "Axe"}, {SKILL_SPEAR, "Spear"}, {SKILL_BOW, "Bow"}, {SKILL_MACE, "Mace"}, {SKILL_BLASTER, "Blaster"}, {SKILL_SHIELD, "Shield"}, {SKILL_LEATHER, "Leather"}, {SKILL_CHAIN, "Chain"}, {SKILL_PLATE, "Plate"}, {SKILL_FIRE, "Fire"}, {SKILL_AIR, "Air"}, {SKILL_WATER, "Water"}, {SKILL_EARTH, "Earth"}, {SKILL_SPIRIT, "Spirit"}, {SKILL_MIND, "Mind"}, {SKILL_BODY, "Body"}, {SKILL_LIGHT, "Light"}, {SKILL_DARK, "Dark"}, {SKILL_IDENTIFY_ITEM, "IdentifyItem"}, {SKILL_MERCHANT, "Merchant"}, {SKILL_REPAIR, "Repair"}, {SKILL_BODYBUILDING, "Bodybuilding"}, {SKILL_MEDITATION, "Meditation"}, {SKILL_PERCEPTION, "Perception"}, {SKILL_DIPLOMACY, "Diplomacy"}, {SKILL_THIEVERY, "Thievery"}, {SKILL_DISARM_TRAPS, "DisarmTraps"}, {SKILL_DODGING, "Dodging"}, {SKILL_UNARMED, "Unarmed"}, {SKILL_IDENTIFY_MONSTER, "IdentifyMonster"}, {SKILL_ARMSMASTER, "Armsmaster"}, {SKILL_STEALING, "Stealing"}, {SKILL_ALCHEMY, "Alchemy"}, {SKILL_LEARNING, "Learning"} };
}
...
void makeEnumSkills_8()
{
    ...
    ENUM_TO_STRING_SKILLS = { {SKILL_STAFF, "Staff"}, {SKILL_SWORD, "Sword"}, {SKILL_DAGGER, "Dagger"}, {SKILL_AXE, "Axe"}, {SKILL_SPEAR, "Spear"}, {SKILL_BOW, "Bow"}, {SKILL_MACE, "Mace"}, {SKILL_BLASTER, "Blaster"}, {SKILL_SHIELD, "Shield"}, {SKILL_LEATHER, "Leather"}, {SKILL_CHAIN, "Chain"}, {SKILL_PLATE, "Plate"}, {SKILL_FIRE, "Fire"}, {SKILL_AIR, "Air"}, {SKILL_WATER, "Water"}, {SKILL_EARTH, "Earth"}, {SKILL_SPIRIT, "Spirit"}, {SKILL_MIND, "Mind"}, {SKILL_BODY, "Body"}, {SKILL_LIGHT, "Light"}, {SKILL_DARK, "Dark"}, {SKILL_DARK_ELF_ABILITY, "DarkElfAbility"}, {SKILL_VAMPIRE_ABILITY, "VampireAbility"}, {SKILL_DRAGON_ABILITY, "DragonAbility"}, {SKILL_IDENTIFY_ITEM, "IdentifyItem"}, {SKILL_MERCHANT, "Merchant"}, {SKILL_REPAIR, "Repair"}, {SKILL_BODYBUILDING, "Bodybuilding"}, {SKILL_MEDITATION, "Meditation"}, {SKILL_PERCEPTION, "Perception"}, {SKILL_REGENERATION, "Regeneration"}, {SKILL_DISARM_TRAPS, "DisarmTraps"}, {SKILL_DODGING, "Dodging"}, {SKILL_UNARMED, "Unarmed"}, {SKILL_IDENTIFY_MONSTER, "IdentifyMonster"}, {SKILL_ARMSMASTER, "Armsmaster"}, {SKILL_STEALING, "Stealing"}, {SKILL_ALCHEMY, "Alchemy"}, {SKILL_LEARNING, "Learning"} };
}
