...
std::vector<int> ALL_PLAYER_BUFF;
...
std::vector<int> ALL_MONSTER_BITS;
...
std::vector<int> ALL_MONSTER_BUFF;
...
std::vector<int> ALL_MONSTER_BONUS;
...
std::vector<int> ALL_MONSTER_KIND;
...
HOUSE_TYPE_SPELL_SHOP = INVALID_ID,
...
void makeEnumHouseType_7()
{
    ...
    ALL_HOUSE_TYPE = { HOUSE_TYPE_WEAPON_SHOP, HOUSE_TYPE_ARMOR_SHOP, HOUSE_TYPE_MAGIC_SHOP, HOUSE_TYPE_ALCHEMIST, HOUSE_TYPE_FIRE_GUILD, HOUSE_TYPE_AIR_GUILD, HOUSE_TYPE_WATER_GUILD, HOUSE_TYPE_EARTH_GUILD, HOUSE_TYPE_SPIRIT_GUILD, HOUSE_TYPE_MIND_GUILD, HOUSE_TYPE_BODY_GUILD, HOUSE_TYPE_LIGHT_GUILD, HOUSE_TYPE_DARK_GUILD, HOUSE_TYPE_SPELL_SHOP, HOUSE_TYPE_SELF_GUILD, HOUSE_TYPE_TOWN_HALL, HOUSE_TYPE_MERC_GUILD, HOUSE_TYPE_THRONE, HOUSE_TYPE_TAVERN, HOUSE_TYPE_BANK, HOUSE_TYPE_TEMPLE, HOUSE_TYPE_CASTLE_ENT, HOUSE_TYPE_DUNGEON_ENTRANCE, HOUSE_TYPE_SEER_EVIL, HOUSE_TYPE_STABLES, HOUSE_TYPE_BOATS, HOUSE_TYPE_HOUSE, HOUSE_TYPE_TRAINING, HOUSE_TYPE_JAIL, HOUSE_TYPE_CIRCUS, HOUSE_TYPE_THE_ADVENTURERS_INN };
}
...
std::vector<int> ALL_HOUSE_SCREENS;
...
std::vector<int> ALL_FACE_ANIMATION;
