...

{
	...
	void makeEnumStats_6()
	{
		...
		STATS_ALL = { STAT_MIGHT, STAT_INTELLECT, STAT_PERSONALITY, STAT_ENDURANCE, STAT_ACCURACY, STAT_SPEED, STAT_LUCK, STAT_HIT_POINTS, STAT_SPELL_POINTS, STAT_ARMOR_CLASS, STAT_FIRE_RESISTANCE, STAT_ELEC_RESISTANCE, STAT_COLD_RESISTANCE, STAT_POISON_RESISTANCE, STAT_LEVEL, STAT_MELEE_ATTACK, STAT_MELEE_DAMAGE_BASE, STAT_MELEE_DAMAGE_MIN, STAT_MELEE_DAMAGE_MAX, STAT_RANGED_ATTACK, STAT_RANGED_DAMAGE_BASE, STAT_RANGED_DAMAGE_MIN, STAT_RANGED_DAMAGE_MAX, STAT_MAGIC_RESISTANCE };
