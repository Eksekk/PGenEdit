...
namespace consts
{
	...
	extern int64_t
		...
		SCREEN_INVENTORY,
		SCREEN_SPELL_BOOK,
		SCREEN_NEW_GAME_BRIEFING,
		SCREEN_CHEST,
		SCREEN_SAVE_GAME,
		SCREEN_LOAD_GAME,
		SCREEN_HOUSE,
		SCREEN_INVENTORY_IN_SHOP,
		SCREEN_INVENTORY_IN_CHEST,
		SCREEN_MOVIE,
		SCREEN_WALK_TO_MAP,
		SCREEN_MAP_ENTRANCE,
		SCREEN_SIMPLE_MESSAGE,
		SCREEN_SELECT_TARGET,
		SCREEN_CREATE_PARTY,
		SCREEN_ESC_MESSAGE,
		SCREEN_ITEM_SPELL,
		SCREEN_KEY_CONFIG,
		SCREEN_VIDEO_OPTIONS,
		SCREEN_ADVENTURERS_INN,
		SCREEN_ITEM_SPELL_MM6,
		SCREEN_QUICK_REFERENCE;

	extern std::vector<int64_t> SCREENS_ALL;
	extern std::map<int64_t, std::string> ENUM_TO_STRING_SCREENS;
	extern std::map<std::string, int64_t> STRING_TO_ENUM_SCREENS;

	bool checkScreensValidity(int64_t value);

	extern void makeEnumScreens_6();
	extern void makeEnumScreens_7();
	extern void makeEnumScreens_8();
