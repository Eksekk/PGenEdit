...
public:
	...
	[[nodiscard]] virtual Mastery getSkillMaxMastery(int skillId, const SkillOptions& options = SkillOptions()) = 0;
	...
	virtual void setBlackPotionUsed(int statId, bool used) = 0;
...
public:
	...
	virtual Mastery getSkillMaxMastery(int skillId, const SkillOptions& options = SkillOptions()) override;
