...
extern "C"
{
	...
	extern "C" static int printMonsters(lua_State * L)
	{
		...
		wxLogInfo("Map monsters: %s", util::string::convertAndConcat(ids));
	}
...
/// <param name="idx">The index of the value on the Lua stack.</param>
/// <returns>
/// A string representing the Lua type name at the specified index.
/// </returns>
...
/// <summary>
/// Checks if the Lua stack size matches the expected size and throws an error if not.
/// </summary>
/// <param name="L">The Lua state pointer</param>
...
/// </summary>
/// <param name="L">The Lua state.</param>
/// <param name="index">The index of the table on the Lua stack.</param>
/// <param name="name">The name of the metafield to check for.</param>
