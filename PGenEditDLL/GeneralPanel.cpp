	...
	: wxPanel(parent, id, pos, size, style, title)
{
	...
	m_staticText10 = new wxStaticText(this, wxID_ANY, _("Average party strength (in levels)"));
	...
	miscSkillsOnePlayerCheckbox = new wxCheckBox(this, wxID_ANY, _("Grant each misc skill for at most one player"));
	...
	generateArtifactsCheckbox = new wxCheckBox(this, wxID_ANY, _("Allow artifact generation"));
	generalSettingsSizer->Add(generateArtifactsCheckbox, 0, wxALL, 5);

	clearFoundArtifactsCheckbox = new wxCheckBox(this, wxID_ANY, _("Clear found artifacts list"));
	...
	markArtifactsAsFoundCheckbox = new wxCheckBox(this, wxID_ANY, _("Mark generated artifacts as found"));
	...
	generateGoldCheckbox = new wxCheckBox(this, wxID_ANY, _("Generate gold"));
	generateGoldSizer->Add(generateGoldCheckbox, 0, wxALL | wxEXPAND, 5);

	m_staticText1 = new wxStaticText(this, wxID_ANY, _("Min:"));
	...
	m_staticText2 = new wxStaticText(this, wxID_ANY, _("Max:"));
	...
	clearBankGoldCheckbox = new wxCheckBox(this, wxID_ANY, _("Clear bank gold"));
	generateGoldSizer->Add(clearBankGoldCheckbox, 0, wxALIGN_CENTER_VERTICAL | wxALL, 5);

	removeFineCheckbox = new wxCheckBox(this, wxID_ANY, _("Remove fine (MM7+)"));
	...
	generateFoodCheckbox = new wxCheckBox(this, wxID_ANY, _("Generate food"));
	generateFoodSizer->Add(generateFoodCheckbox, 0, wxALL | wxEXPAND, 5);

	m_staticText11 = new wxStaticText(this, wxID_ANY, _("Min:"));
	...
	m_staticText21 = new wxStaticText(this, wxID_ANY, _("Max:"));
	...
	clearConditionsCheckbox = new wxCheckBox(this, wxID_ANY, _("Clear conditions"));
	clearConditionsCheckbox->SetValue(true);
	partyConditionSizer->Add(clearConditionsCheckbox, 0, wxALL, 5);

	fullHpSpCheckbox = new wxCheckBox(this, wxID_ANY, _("Full HP/SP"));
	fullHpSpCheckbox->SetValue(true);
	partyConditionSizer->Add(fullHpSpCheckbox, 0, wxALL, 5);

	dispelPartyCheckbox = new wxCheckBox(this, wxID_ANY, _("Remove active buffs and statistics bonuses"));
