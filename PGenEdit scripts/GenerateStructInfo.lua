...
do
	...
	local sourceBaseStart = {
		"#include \"pch.h\"",
		format("#include \"%s\"", "constDefinitionsAutoGenerated.h"),
		format("#include \"%s\"", "Enum_const.h"),
		format("#include \"%s\"", "Utility.h"),
		"",
		"namespace consts\n",
		"{",
	}
...
function writeConsts()
	...
	processConstFinish()
	io.save("constDefinitionsAutoGenerated.h", table.concat(header, "\n"))
	io.save("constDefinitionsAutoGenerated.cpp", table.concat(source, "\n"))
	reinitConsts()
end